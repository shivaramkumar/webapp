...
# Reading .env file
environ.Env.read_env(os.path.join(BASE_DIR, 'docker-compose.env'))
...
SECRET_KEY = "django-insecure-xf^&th=1@0&=pbqy^m5&6i64nk#4$_4e@tihxhi-n_os&qnxdh"
...
DATABASES["default"] = DATABASES[env("DATABASE_OPTION")]
